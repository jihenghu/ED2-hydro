...
subroutine ed_masterput_nl(par_run)
   ...
   call MPI_Bcast(hydraulic_redistribution,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(control_photosynthesis,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(control_leaf_par,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(control_leaf_tmp,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(control_leaf_vpd,1,MPI_REAL,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(iddmort_scheme,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(imort_scheme,1,MPI_INTEGER,mainnum,MPI_COMM_WORLD,ierr)
...
!----- Now the namelist -------------------------------------------------------------------!
   ...
   call MPI_Bcast(hydraulic_redistribution,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(control_photosynthesis,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(control_leaf_par,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(control_leaf_tmp,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(control_leaf_vpd,1,MPI_REAL,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(iddmort_scheme,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
   call MPI_Bcast(imort_scheme,1,MPI_INTEGER,master_num,MPI_COMM_WORLD,ierr)
