...
module growth_balive
         ...
         siteloop: do isi = 1,cpoly%nsites
            ...
            patchloop: do ipa = 1,csite%npatches
               ...
               cohortloop: do ico = 1,cpatch%ncohorts
                  ...
                  dlnndt   = - (sum(cpatch%mort_rate(1:n_mort,ico)) - cpatch%mort_rate(5,ico))
                  ! the 5th one is just for accounting, not used
   ...
   subroutine update_plc(cpatch,ico)
      ...
      !------------------------------------------------------------------------------------!
      ipft = cpatch%pft(ico)
      plc_today  =  max(0., 1. - 1. / (1. + (cpatch%dmin_leaf_psi(ico) / wood_psi50(ipft)) &
                                       ** wood_Kexp(ipft)))
