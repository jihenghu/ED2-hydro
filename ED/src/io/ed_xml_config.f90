...
! respiration & turnover variables
           ...
           call getConfigREAL  ('stem_resp_size_factor','pft',i,rval,texist)
           if(texist) stem_resp_size_factor(myPFT) = real(rval)
           call getConfigREAL  ('stem_resp_growth_factor','pft',i,rval,texist)
           if(texist) stem_resp_growth_factor(myPFT) = real(rval)
...
! mortality
           ...
           call getConfigREAL  ('mort_plc_max','pft',i,rval,texist)
           if(texist) mort_plc_max(myPFT) = real(rval)
           call getConfigREAL  ('mort_plc_th' ,'pft',i,rval,texist)
           if(texist) mort_plc_th (myPFT) = real(rval)
           ...
           call getConfigREAL  ('mort_alpha','pft',i,rval,texist)
           if(texist) mort_alpha(myPFT) = real(rval)
           call getConfigREAL  ('mort_beta','pft',i,rval,texist)
           if(texist) mort_beta(myPFT) = real(rval)
...
!! RESPIRAION AND TURNOVER
        ...
        call putConfigREAL("stem_resp_size_factor",stem_resp_size_factor(i))
        call putConfigREAL("stem_resp_growth_factor",stem_resp_growth_factor(i))
...
!! MORTALITY
        ...
        call putConfigREAL("mort_plc_max",mort_plc_max(i))
        call putConfigREAL("mort_plc_th",mort_plc_th(i))
        ...
        call putConfigREAL("mort_alpha",mort_alpha(i))
        call putConfigREAL("mort_beta",mort_beta(i))
